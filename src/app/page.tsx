        ...
        <div className="max-w-screen-lg mx-auto">
          <div className="middle-part bg-black text-white mb-2 p-8">
            ...
            <div className="mt-6 flex items-center justify-center">
              <button className="bg-[#0054ae] p-3 rounded-lg w-full max-w-52 hover:bg-sky-300 hover:text-black">
              ...
              <button className="bg-[#0054ae] p-3 rounded-lg w-full max-w-52 mx-3 hover:bg-sky-300 hover:text-black">
                <span className="flex space-x-4 items-center justify-center">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    height="1em"
                  ...
                  <a className="font-bold text-xl" href="windows">
                    Windows
                  </a>
                </span>
              </button>
            ...
            <div className="flex items-center justify-center mt-8">
              <button className="font-bold text-xl flex items-center justify-center space-x-4 bg-[#0054ae] p-3 rounded-lg w-full max-w-72 hover:bg-sky-300 hover:text-black">
                <svg
                  viewBox="0 0 512 512"
                  width="16"
                  height="16"
